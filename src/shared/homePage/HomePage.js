    ...
    <React.Fragment>
      ...
      <div id="middle">
        ...
        <p style={{ marginTop: 0 }}>
          ...
          Ideas to solve them, give their solutions for the problems and Meet-up
          with the other Developers to make something.{" "}
        </p>
      </div>
      <div id="features">
        <div>
      ...
      <div id="credits">
        ...
        <div>
          ...
          <div>
            <img
              src={Dhyata}
              onMouseMove={() => screen.width > 1024 && showGithubIcon(1)}
              onMouseOut={() => hideGithubIcon(1)}
              alt="Dhyata"
              onClick={() => {
                navigate("https://github.com/DhyataGarg");
              }}
            />
            <p>Dhyata</p>
            <i
          ...
          <div>
            <img
              src="https://avatars.githubusercontent.com/u/74733831?s=460&u=1d78d875b43d9493a4ffd0635a3e6806ea14c968&v=4"
              onMouseMove={() => screen.width > 1024 && showGithubIcon(2)}
              onMouseOut={() => hideGithubIcon(2)}
              alt="Dhairya Taneja"
              onClick={() => {
                navigate("https://github.com/Dhairya0012");
              }}
            />
            <p>Dhairya Tanjea</p>
            <i
          ...
          <div>
            <img
              src="https://avatars.githubusercontent.com/u/78211726?s=460&u=a12d367dd4f36288024329e7a9b27f0048f56d51&v=4"
              onMouseMove={() => screen.width > 1024 && showGithubIcon(3)}
              onMouseOut={() => hideGithubIcon(3)}
              alt="Dikshant Mitrav"
              onClick={() => {
                navigate("https://github.com/DikshantMitrav");
              }}
            />
            <p>Dikshant Mitrav</p>
            <i
